...
* to remove. The files with the assigned averages calculated is provided.
...
import excel using "clean_data/plants_18.xlsx", firstrow clear

rename tx_antigo tx
drop H
la var tx "Emission Rate - tCO2/MWh"

save "clean_data/plants_18.dta"


use "clean_data/generation_18.dta", clear
merge m:1 ceg using "clean_data/plants_18.dta"
...
* in all of them. More detailed on the manual
* step is presented in the read me file.
****************************************************
...
import excel using "clean_data/plants_19.xlsx", firstrow clear

rename tx_antigo tx
drop H
la var tx "Emission Rate - tCO2/MWh"

save "clean_data/plants_19.dta"


use "clean_data/generation_19.dta", clear
merge m:1 ceg using "clean_data/plants_19.dta"
...
* MANUAL STEP REQUIRED
********************************************************************************
import excel using "clean_data/plants_20.xlsx", firstrow clear

rename tx_antigo tx
la var tx "Emission Rate - tCO2/MWh"

save "clean_data/plants_20.dta"



use "clean_data/generation_20.dta", clear
merge m:1 ceg using "clean_data/plants_20.dta"
...
* MANUAL STEP REQUIRED
********************************************************************************
import excel using "clean_data/plants_21.xlsx", firstrow clear

rename tx_antigo tx
la var tx "Emission Rate - tCO2/MWh"

save "clean_data/plants_21.dta"



use "clean_data/generation_21.dta", clear
merge m:1 ceg using "clean_data/plants_21.dta"
...
* MANUAL STEP REQUIRED
********************************************************************************
import excel using "clean_data/plants_22.xlsx", firstrow clear

rename tx_antigo tx
la var tx "Emission Rate - tCO2/MWh"

save "clean_data/plants_22.dta"



use "clean_data/generation_22.dta", clear
merge m:1 ceg using "clean_data/plants_22.dta"
...
* MANUAL STEP REQUIRED
********************************************************************************
import excel using "clean_data/plants_23.xlsx", firstrow clear

rename tx_antigo tx
la var tx "Emission Rate - tCO2/MWh"

save "clean_data/plants_23.dta"



use "clean_data/generation_23.dta", clear
merge m:1 ceg using "clean_data/plants_23.dta"
...
* MANUAL STEP REQUIRED
********************************************************************************
import excel using "clean_data/plants_24.xlsx", firstrow clear

rename tx_antigo tx
la var tx "Emission Rate - tCO2/MWh"

save "clean_data/plants_24.dta"

use "clean_data/generation_24.dta", clear
merge m:1 ceg using "clean_data/plants_24.dta"
